...
Fluent UI itself has a detailed accessibility architecture worth knowing before you build on it — component labelling anti-patterns, focus-indicator APIs, live-region/notification best practices, and truncation guidance. See [Accessibility in Fluent UI React (v9)](../generic/index.md) for the full breakdown.
...
- [Accessibility in Fluent UI React (v9)](../generic/index.md) — component labelling, focus indicators, live regions, and truncation guidance for the library PCF recommends
