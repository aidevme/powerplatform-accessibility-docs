...
Guidance is organized by product area under [`docs/`](docs):

- [Power Pages](docs/powerpages) — standards conformance and accessible site customization (forms, Liquid, Power BI embeds).
...
- [Power Apps – Generative/AI-generated pages](docs/powerapps-generative-pages)
- [Generic / cross-cutting guidance](docs/generic)
